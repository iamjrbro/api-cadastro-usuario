...
const rolesCadastradas = ('../middleware/roles.js')
const permissoesCadastradas = ('../middleware/permissoes.js')

const router = Router()

router
  .post('/produto', ProdutoController.cadastrarProduto)
  .get('/produto', rolesCadastradas, permissoes, ProdutoController.buscarTodosProdutos)
